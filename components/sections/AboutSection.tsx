    ...
    <SectionContainer>
      ...
      <div className='w-full flex flex-col gap-6'>
        ...
        <AnimationContainer customClassName='w-full flex flex-col gap-5 mb-8'>
          ...
          <p className='text-base text-gray-400'>
            A look at all the programming languages, libraries, and tools I've worked with, I started programming about +{calculateDuration('2022-01-01', false)} ago. I have tried a few programming languages and technology stack, both Backend and Frontend.
          </p>
